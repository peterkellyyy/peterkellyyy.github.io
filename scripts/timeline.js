...
job,markforged,Markforged,Research and Development Engineer II,2022-04-01,2024-09-01,,logos/Markforged.png,#111111,,"Led FX10 metal printhead R&D from concept to EVT while owning subsystem designs, test deliverables, drawings, and continuous-fiber co-part research that produced parts up to 6.4x stronger.",,0
job,markforged,Markforged,Research and Development Engineer I,2021-06-01,2022-04-01,,logos/Markforged.png,#111111,,"Designed proof-of-concept electromechanical systems for novel 3D printing and continuous-fiber processes, led Metal X fine features R&D to launch, and built production tooling for overseas manufacturing.",,0
job,siliconsynapse,NEU SiliconSynapse Lab,Graduate Research Assistant,2020-01-01,2021-06-01,,logos/SiliconSynapse Lab.png,#93A7AC,,"Led design, simulation, fabrication, and testing of lightweight thruster-assisted legged robots and biomimetic flapping wing mechanisms, including custom actuators, EDF selection, and generative mass-allocation tools.",,0
job,morse,MORSE Corp,Mechanical Engineering Co-op,2019-01-01,2019-07-01,,logos/MORSE.png,#005EB8,,"Designed, fabricated, and tested disappearing-polymer parafoil and parachute systems for a DARPA airdrop program, including material test fixtures, a lightweight guidance unit, and surrogate payloads rated for 800 lb dynamic loads.",,0
job,irobot,iRobot,R&D Robotics Engineering Co-op,2018-01-01,2018-07-01,,logos/iRobot.png,#6DB33F,,"Designed and fabricated prototype robot mechanisms, VSLAM camera mounts, and test fixtures for a next-generation platform, using CAD, shop tools, and performance data to cut prototype noise from 60 to 30 dB.",,1
job,sikorsky,Sikorsky Aircraft,Propulsion Engineering Co-op,2017-01-01,2017-09-01,,logos/Sikorsky.png,#005EB8,,"Supported H-60 and CH-53 propulsion manufacturing by designing T-700 engine, inlet, and exhaust modification kits, updating drawings, and writing assembly and installation instructions.",,0
